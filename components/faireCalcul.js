export default function faireCalcul(phrase) {
    ...
    while (nbrOperaterPlusouMoins > 0) {
        ...
        //tester si il y a - au debut du premier (nombre3) nombre pour le renversement
        if (nombre3[nombre3.length - 1] == '-') {
            //effacer le '-' dans le nombre1
            nombre3 = nombre3.replace("-", "");
            //renverser le nombre3 car on l'a fait de sens inverse
            nombre3EnSensNormal = nombre3.split('').reverse().join('');
            //remettre le '-' dans le nombre3
